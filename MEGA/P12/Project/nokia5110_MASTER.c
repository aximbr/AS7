...
void lcd_setXY(char x, char y)		/* set the column and row */
{
	...
	N5110_Cmnd(0x80|x*6);  //set coluna (0 a 83)
	N5110_Cmnd(0x40|y);    //set linha (0 a 5)
}


void N5110_clear(void)					/* clear the Display */
{
	SPI_SS_Enable();
	PORTB |= (1<<DC);
	for (int k=0; k<=503; k++)
...
void N5110_OutUDec(uint16_t n){
  if(n < 10){
    N5110_Data("     ");
    N5110_char(n+'0'); /* n is between 0 and 9 */
  } else if(n<100){
    N5110_Data("    ");
    N5110_char(n/10+'0'); /* tens digit */
    N5110_char(n%10+'0'); /* ones digit */
  } else if(n<1000){
    N5110_Data("   ");
    N5110_char(n/100+'0'); /* hundreds digit */
    n = n%100;
    N5110_char(n/10+'0'); /* tens digit */
    N5110_char(n%10+'0'); /* ones digit */
  }
    ...
    N5110_Data(" ");
    N5110_char(n/1000+'0'); /* thousands digit */
    N5110_char(',');
		n = n%1000;
    N5110_char(n/100+'0'); /* hundreds digit */
    n = n%100;
    ...
    N5110_char(n/10000+'0'); /* ten-thousands digit */
    n = n%10000;
    N5110_char(n/1000+'0'); /* thousands digit */
		N5110_char(',');
    n = n%1000;
